...
do
	...
	do
		#mkdir $i
		cd $i
		cp ../../input/restarts/temp_${Temp%.*}/molality_$m/volume.dat .
		cp ../../input/restarts/temp_${Temp%.*}/molality_$m/density.dat .
		cp ../../input/restarts/temp_${Temp%.*}/molality_$m/log.lammps "log (2).lammps"
